...
output:
 html_document:
   toc: true
params:
    quant_path: /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise1/results/salmon
    tx2gene: /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise1/results/salmon/gencode.v29.transcripts_no-vers_chr21_tx2gene.txt
    vcf:  /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise1/results/annotation/haplotypecaller/joint_variant_calling/joint_germline_recalibrated_snpEff.ann.vcf.gz
    ext_funcs: /Users/mariangelasantorsola/Documents/lab-adv-omics-2023/datasets_LABOS_exercise1/results/annotation/extract_annotations_full.R
...
selectedVars$alphamis_Pathogenicity = c(0.154, 0.139)
selectedVars$alphamis_Class = c("likely_benign", "likely_benign")

#p.His7Gln	0.154	likely_benign
#p.Arg108His	0.139	likely_benign
...
prioritised_variants$Clinical_significance <- c("Benign", "Pathogenic")
prioritised_variants$gnomAD_AF <- c("3.17e-3", "2.48e-6")
prioritised_variants %>% filter(Clinical_significance == "Pathogenic")
